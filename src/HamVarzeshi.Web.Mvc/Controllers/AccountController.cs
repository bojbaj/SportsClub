...
using HamVarzeshi.Sessions;
using HamVarzeshi.Web.Models.Account;
using HamVarzeshi.Web.Views.Shared.Components.TenantChange;

namespace HamVarzeshi.Web.Controllers
{
    public class AccountController : HamVarzeshiControllerBase
    {
