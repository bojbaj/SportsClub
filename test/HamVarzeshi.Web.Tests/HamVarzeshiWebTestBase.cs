...
{
    public abstract class HamVarzeshiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HamVarzeshiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HamVarzeshiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HamVarzeshiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HamVarzeshiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HamVarzeshiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HamVarzeshiDbContext, Task<T>> func)
        {
            T result;
